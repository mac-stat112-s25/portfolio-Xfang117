...
Both addresses used between 0 and 450, and there is a difference of energy using between months.
...
Energy use is higher in winter months,and address has a little influence on energy using.
...
Typical energy use increased after renovations.
...
The luck of outdoor temperature.
```{r}
...
-   After renovation...
-   It makes the temperature to be colder
...
Starbucks is mainly concentrated in the United States, Europe and East Asia.
